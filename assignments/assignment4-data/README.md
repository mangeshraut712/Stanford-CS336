...
> **Portfolio status:** Complete (self-study). See [`PROJECT_STATUS.md`](./PROJECT_STATUS.md), [`SOLUTION.md`](./SOLUTION.md). Tests: `bash scripts/finalize_assignment.sh` → 21/21 pass.
